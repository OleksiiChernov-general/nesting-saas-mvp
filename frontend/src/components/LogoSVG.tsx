...
export function LogoSVG({ className, withWordmark = true }: LogoSVGProps) {
  return (
    <div className={className}>
      <svg aria-hidden="true" className="h-10 w-10 shrink-0" viewBox="0 0 64 64">
        <defs>
          <linearGradient id="nestora-brand-gradient" x1="0%" x2="100%" y1="0%" y2="100%">
        ...
        <path
          ...
          fill="url(#nestora-brand-gradient)"
        />
